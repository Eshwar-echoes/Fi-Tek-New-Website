...
export function ContactHeroSection({ data }: Readonly<{ data: ContactPageContent }>) {
  ...
  return (
    <section className="relative flex min-h-[80vh] items-center pt-12 pb-12 md:min-h-[70vh]">
      <div
      ...
      <div className="relative z-10 w-full">
        <div className="mx-auto flex max-w-7xl justify-center px-4 sm:px-6 md:justify-end">
          <motion.div
            ...
            className="w-full max-w-lg rounded-xl bg-(--overlay-white-soft) p-6 shadow-xl backdrop-blur-lg sm:p-8 md:p-10"
          >
            <div className="mb-8 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-(--text-primary)">{data.heading}</h2>
