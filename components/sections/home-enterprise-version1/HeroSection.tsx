...
export function HeroSection({ data }: Readonly<HeroSectionProps>) {
  ...
  return (
    <section className="relative isolate min-h-[72vh] md:h-[80vh]" aria-label="Hero section">
      {data.media && (
      ...
      <div className="relative z-10 flex min-h-[72vh] items-center py-12 md:h-full md:py-0">
        <Container>
          <motion.div
          ...
          >
            ...
            {data.title.map((line) => (
              <motion.h1
                key={line}
                variants={heroMotion.heading}
                className="mb-0 text-3xl font-bold leading-tight text-(--text-inverse) sm:text-5xl md:text-6xl lg:text-6xl"
              >
                {line}
              </motion.h1>
            ))}
            ...
            <motion.p
              ...
              className="mt-2 text-base leading-relaxed text-(--text-light) md:text-xl"
            >
              {data.description}
            </motion.p>
