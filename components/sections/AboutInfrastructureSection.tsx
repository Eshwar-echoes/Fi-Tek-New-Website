        ...
        <div className="space-y-20 md:space-y-24">
          <motion.div variants={sectionVariants} initial="hidden" whileInView="show" viewport={inViewViewport}>
            <div className="max-w-4xl space-y-6">
              ...
              <h3 className="text-3xl font-semibold leading-tight text-(--text-primary) md:text-3xl">
          ...
          <div className="grid items-stretch gap-10 lg:grid-cols-2 lg:gap-14">
            <motion.div variants={sectionVariants} initial="hidden" whileInView="show" viewport={inViewViewport}>
              <div className="rounded-xl border border-(--border-subtle) bg-(--surface-base) p-8 md:p-10">
            ...
            <motion.div variants={sectionVariants} initial="hidden" whileInView="show" viewport={inViewViewport}>
              <div className="relative overflow-hidden rounded-xl border border-(--border-subtle) bg-linear-to-br from-(--surface-muted) to-(--surface-base) p-6 md:p-8">
                <div className="h-[360px] md:h-full md:min-h-[420px]">
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 640 480"
